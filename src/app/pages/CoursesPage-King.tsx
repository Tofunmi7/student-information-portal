...
import { BookOpen, User, MapPin, Clock, Plus, Trash2, CheckCircle, FolderOpen, BookMarked } from 'lucide-react';
    ...
    <DashboardLayout>
      ...
      <div className="flex gap-2 mb-4 sm:mb-6 overflow-x-auto pb-2">
        <button
          ...
          className={`px-3 sm:px-6 py-2 sm:py-3 rounded-lg transition-colors whitespace-nowrap text-xs sm:text-sm flex items-center gap-2 ${
      ...
      {activeTab === 'registered' && (
        <div className="space-y-3 sm:space-y-4">
          {registered.length === 0 ? (
            ...
            >
              <BookMarked size={48} style={{ color: 'var(--color-text-tertiary)', margin: '0 auto 1rem' }} />
        ...
        <div className="space-y-3 sm:space-y-4">
          {available.length === 0 ? (
            <div
              ...
              style={{ backgroundColor: 'var(--color-surface)' }}
            >
              <FolderOpen size={48} style={{ color: 'var(--color-text-tertiary)', margin: '0 auto 1rem' }} />
              <p className="text-xs sm:text-sm" style={{ color: 'var(--color-text-secondary)' }}>

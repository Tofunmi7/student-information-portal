...
import { Bell, AlertCircle, Calendar, Info, Filter, Loader2, ExternalLink, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <DashboardLayout>
      ...
      >
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <div className="flex items-center gap-2 w-full sm:w-auto mb-2 sm:mb-0">
            ...
            <span className="text-xs sm:text-sm" style={{ color: 'var(--color-text-secondary)' }}>Filters:</span>
          </div>
          <button
            className="px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm transition-colors flex items-center gap-2"
            style={{
          ...
          <button
            className="px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm border transition-colors hover:bg-gray-50 flex items-center gap-2"
            style={{
      ...
      <div className="mt-4 sm:mt-6 text-center">
        <button
          className="px-4 sm:px-6 py-2 sm:py-3 rounded-lg border transition-colors hover:bg-gray-50 text-xs sm:text-sm flex items-center justify-center gap-2 mx-auto"
          style={{
            borderColor: 'var(--color-border)',
            color: 'var(--color-text-secondary)'
          }}

...
import { Mail, Phone, MapPin, Book, Calendar, Award } from 'lucide-react';
    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        >
          ...
          <button
            className="w-full mt-4 sm:mt-6 py-2 rounded-lg text-white transition-colors hover:opacity-90 text-sm sm:text-base"
            style={{ backgroundColor: 'var(--color-primary)' }}
          >
            Edit Profile
          </button>
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--color-surface)' }}
          >
            <h3 className="mb-3 sm:mb-4 text-base sm:text-lg">Academic Information</h3>
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--color-surface)' }}
          >
            <h3 className="mb-3 sm:mb-4 text-base sm:text-lg">Personal Information</h3>
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--color-surface)' }}
          >
            <h3 className="mb-3 sm:mb-4 text-base sm:text-lg">Guardian Information</h3>
